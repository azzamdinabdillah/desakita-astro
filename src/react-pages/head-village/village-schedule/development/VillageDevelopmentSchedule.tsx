    ...
    <div className="flex flex-col gap-6">
      <TitlePage
        ...
        leftElement={
          <a
            href={
              "/head-village/village-schedule/village-development-schedule/create-village-development-schedule"
            }
          >
        ...
        <div className="top flex flex-wrap justify-between items-center gap-3">
          <div className="md:max-w-[370px] w-full">
            <Inputs
              ...
              placeholder="Search village development name"
                ...
                <td>
                  <div className="flex gap-4 lg:gap-6 flex-col w-full">
                    <div className="flex justify-between items-center flex-wrap gap-4">
                      ...
                      <a
                        href={
                          "/head-village/village-schedule/village-development-schedule/manage-village-development-schedule"
                        }
                      >
